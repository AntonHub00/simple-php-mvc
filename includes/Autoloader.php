...
#so it is not necessary to do it manually for each required class.
#
#You can add more else-if statements if you want other paths from where you
#want your classes to be autoloaded.
